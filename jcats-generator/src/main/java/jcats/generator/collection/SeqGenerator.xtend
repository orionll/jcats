...
final class SeqGenerator implements ClassGenerator {
	...
	override sourceCode() { '''
		...
		public abstract class Seq<A> implements Sized, Indexed<A>, Serializable {
			...
			static int checkRangeAndConvert(final int index, final int startIndex, final int length) {
		...
		final class Seq1<A> extends Seq<A> {
			...
			public Seq<A> prepend(final A value) {
				...
				if (node1.length == 1 << 5) {
					...
					return new Seq2<>(newNode2, (1 << 5) - 1, (1 << 5) + 1);
				} else {
		...
		final class Seq2<A> extends Seq<A> {
			...
			Seq2(final Object[][] node2, final int startIndex, final int length) {
				this.node2 = node2;
			...
			@Override
			public A get(final int index) {
				final int idx = checkRangeAndConvert(index, startIndex, length);
			...
			public Seq<A> set(final int index, final A value) {
				...
				return new Seq2<>(newNode2, startIndex, length);
			}
			...
			public Seq<A> prepend(final A value) {
				...
				if (node1.length == 1 << 5) {
					...
					final Object[][] newNode2 = node2.clone();
					newNode2[0] = newNode1;
					return new Seq2<>(newNode2, startIndex - 1, length + 1);
				}
			}
			...
			public Seq<A> append(final A value) {
				...
				if (node1.length == 1 << 5) {
					if (node2.length == 1 << 5) {
						...
						return new Seq3<>(newNode3, startIndex, length + 1);
					} else {
						final Object[] newNode1 = { value };
						final Object[][] newNode2 = Arrays.copyOf(node2, node2.length + 1);
						newNode2[node2.length] = newNode1;
						return new Seq2<>(newNode2, startIndex, length + 1);
					}
				} else {
					final Object[] newNode1 = Arrays.copyOf(node1, node1.length + 1);
					newNode1[node1.length] = value;
		...
		final class Seq3<A> extends Seq<A> {
			...
			Seq3(final Object[][][] node3, final int startIndex, final int length) {
				this.node3 = node3;
				this.startIndex = startIndex;
				this.length = length;
			}
			...
			public Seq<A> set(final int index, final A value) {
				...
				newNode2[index2] = newNode1;
				newNode1[index1] = value;
				return new Seq3<>(newNode3, startIndex, length);
			}
				...
				if (node1.length == 1 << 5) {
					if (node2.length == 1 << 5) {
						if (node3.length == 1 << 5) {
							...
							return new Seq4<>(newNode4, (1 << 15) - 1, length + 1);
						} else {
							final Object[] newNode1 = { value };
							final Object[][] newNode2 = { newNode1 };
						...
						final Object[][][] newNode3 = node3.clone();
						newNode3[0] = newNode2;
						return new Seq3<>(newNode3, startIndex - 1, length + 1);
					}
				} else {
					final Object[] newNode1 = new Object[node1.length + 1];
					System.arraycopy(node1, 0, newNode1, 1, node1.length);
				...
				if (node1.length == 1 << 5) {
					if (node2.length == 1 << 5) {
						if (node3.length == 1 << 5) {
							...
							return new Seq4<>(newNode4, startIndex, length + 1);
						} else {
							final Object[] newNode1 = { value };
							final Object[][] newNode2 = { newNode1 };
		...
		final class Seq4<A> extends Seq<A> {
			...
			Seq4(final Object[][][][] node4, final int startIndex, final int length) {
				this.node4 = node4;
				this.startIndex = startIndex;
				this.length = length;
			}
			...
			public Seq<A> set(final int index, final A value) {
				...
				newNode2[index2] = newNode1;
				newNode1[index1] = value;
				return new Seq4<>(newNode4, startIndex, length);
			}
					...
					if (node2.length == 1 << 5) {
						if (node3.length == 1 << 5) {
							if (node4.length == 1 << 5) {
								...
								return new Seq5<>(newNode5, (1 << 20) - 1, length + 1);
							} else {
								final Object[] newNode1 = { value };
								final Object[][] newNode2 = { newNode1 };
								final Object[][][] newNode3 = { newNode2 };
							...
							final Object[][][][] newNode4 = node4.clone();
							newNode4[0] = newNode3;
							return new Seq4<>(newNode4, startIndex - 1, length + 1);
						}
					} else {
						final Object[] newNode1 = { value };
						final Object[][] newNode2 = new Object[node2.length + 1][];
					...
					if (node2.length == 1 << 5) {
						if (node3.length == 1 << 5) {
							if (node4.length == 1 << 5) {
								...
								return new Seq5<>(newNode5, startIndex, length + 1);
							} else {
								final Object[] newNode1 = { value };
								final Object[][] newNode2 = { newNode1 };
								final Object[][][] newNode3 = { newNode2 };
		...
		final class Seq5<A> extends Seq<A> {
			...
			Seq5(final Object[][][][][] node5, final int startIndex, final int length) {
				this.node5 = node5;
				this.startIndex = startIndex;
				this.length = length;
			}
			...
			public Seq<A> set(final int index, final A value) {
				...
				newNode2[index2] = newNode1;
				newNode1[index1] = value;
				return new Seq5<>(newNode5, startIndex, length);
			}
						...
						if (node3.length == 1 << 5) {
							if (node4.length == 1 << 5) {
								if (node5.length == 1 << 5) {
									...
									return new Seq6<>(newNode6, (1 << 25) - 1, length + 1);
								} else {
									final Object[] newNode1 = { value };
									final Object[][] newNode2 = { newNode1 };
									final Object[][][] newNode3 = { newNode2 };
								...
								final Object[][][][][] newNode5 = node5.clone();
								newNode5[0] = newNode4;
								return new Seq5<>(newNode5, startIndex - 1, length + 1);
							}
						} else {
							final Object[] newNode1 = { value };
							final Object[][] newNode2 = { newNode1 };
						...
						if (node3.length == 1 << 5) {
							if (node4.length == 1 << 5) {
								if (node5.length == 1 << 5) {
									...
									return new Seq6<>(newNode6, startIndex, length + 1);
								} else {
									final Object[] newNode1 = { value };
									final Object[][] newNode2 = { newNode1 };
									final Object[][][] newNode3 = { newNode2 };
		...
		final class Seq6<A> extends Seq<A> {
			...
			Seq6(final Object[][][][][][] node6, final int startIndex, final int length) {
				this.node6 = node6;
				this.startIndex = startIndex;
				this.length = length;
			}
			...
			public Seq<A> set(final int index, final A value) {
				...
				newNode2[index2] = newNode1;
				newNode1[index1] = value;
				return new Seq6<>(newNode6, startIndex, length);
			}
						...
						if (node3.length == 1 << 5) {
							if (node4.length == 1 << 5) {
								if (node5.length == 1 << 5) {
									...
									final Object[][][][][][] newNode6 = node6.clone();
									newNode6[0] = newNode5;
									return new Seq6<>(newNode6, startIndex - 1, length + 1);
								}
							} else {
								final Object[] newNode1 = { value };
								final Object[][] newNode2 = { newNode1 };
